  ...
  return (
    <div className="login_page">
      <div className="reklama">
        ...
        <p>Объект индуцирует элементарный экситон. Поверхность, в согласии с традиционными представлениями, притягивает фонон. Газ, несмотря на внешние воздействия, гомогенно испускает объект.</p>
      ...
      <div className='login'>
        ...
        <div className="login_right">
          ...
          />
          <input type="password" placeholder='password' onChange={(e) => setLogParol(e.target.value)} />
